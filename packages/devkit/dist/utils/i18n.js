...
import { TextLanguages } from "../config.js";
...
function getSupportedLanguage(lang) {
  ...
  return supportedLanguages.includes(validatedLang) ? validatedLang : undefined;
}
export async function loadTranslations(configLang) {

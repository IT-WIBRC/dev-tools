...
} from "../../../../src/core/config/search.js";
import { CONFIG_FILE_NAMES as configFileNameFromSchema } from "../../../../src/utils/schema/schema.js";

const CONFIG_FILE_NAMES = configFileNameFromSchema as unknown as string[];
const {
